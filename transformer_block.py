...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        #convolution layer after the transformer, keeps dimension the same
        #self.conv_layer = nn.Conv2d(self.dim, self.dim, 3, padding=1)
        #self.activation = nn.LeakyReLU()
...
#--------------------------------------------------------------------------------------
# code below is not used in deep recursive transformer, but might be potentially useful
#--------------------------------------------------------------------------------------
